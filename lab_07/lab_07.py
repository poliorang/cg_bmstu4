...
def draw_line():
    ...
    canvas_win.create_line(line_coords[0], line_coords[1], fill=color, tag='line')
    print(lines)
...
def draw_clipper():
    ...
    canvas_win.create_rectangle(clipper_coords[0], clipper_coords[1], outline=color, tag='clipper')
...
def draw_point(ev_x, ev_y, click_):
    ...
    if option_line.get() == 0:
        ...
        if len(clipper_coords) > 0:
            clipper_coords[0] = [x, y]
        else:
            clipper_coords.append([x, y])
        ...
        if len(clipper_coords) == 2:
            clipper_coords = clipper_coords[0:1]
        clipper_coords.append([x, y])
...
def cut_area():
    ...
    clipper = [min(clipper_coords[0][0], clipper_coords[1][0]), min(clipper_coords[0][1], clipper_coords[1][1]),
               max(clipper_coords[0][0], clipper_coords[1][0]), max(clipper_coords[0][1], clipper_coords[1][1])]
    for line in lines:
        print(line)
...
def config(event):
    if event.widget == win:
        ...
        # координаты отрезка
        line_lbl.place(x=30 * win_x, y=48 * win_y, width=237 * win_x, height=24 * win_y)

        x1_lbl.place(x=30 * win_x, y=80 * win_y, width=30 * win_x, height=18 * win_y)
        y1_lbl.place(x=156 * win_x, y=80 * win_y, width=30 * win_x, height=18 * win_y)
        x1_entry.place(x=62 * win_x, y=80 * win_y, width=80 * win_x, height=20 * win_y)
        y1_entry.place(x=188 * win_x, y=80 * win_y, width=80 * win_x, height=20 * win_y)

        x2_lbl.place(x=30 * win_x, y=102 * win_y, width=30 * win_x, height=18 * win_y)
        y2_lbl.place(x=156 * win_x, y=102 * win_y, width=30 * win_x, height=18 * win_y)
        x2_entry.place(x=62 * win_x, y=102 * win_y, width=80 * win_x, height=20 * win_y)
        y2_entry.place(x=188 * win_x, y=102 * win_y, width=80 * win_x, height=20 * win_y)

        add_line.place(x=30 * win_x, y=125 * win_y, width=237 * win_x, height=25 * win_y)

        point1_radio.place(x=3 * win_x, y=75 * win_y)
        point2_radio.place(x=3 * win_x, y=97 * win_y)


        # координаты отсекателя
        clipper_lbl.place(x=30 * win_x, y=190 * win_y, width=196 * win_x, height=24 * win_y)

        x1_clipper_lbl.place(x=30 * win_x, y=222 * win_y, width=30 * win_x, height=18 * win_y)
        y1_clipper_lbl.place(x=156 * win_x, y=222 * win_y, width=30 * win_x, height=18 * win_y)
        x1_clipper_entry.place(x=62 * win_x, y=222 * win_y, width=80 * win_x, height=20 * win_y)
        y1_clipper_entry.place(x=188 * win_x, y=222 * win_y, width=80 * win_x, height=20 * win_y)

        x2_clipper_lbl.place(x=30 * win_x, y=244 * win_y, width=30 * win_x, height=18 * win_y)
        y2_clipper_lbl.place(x=156 * win_x, y=244 * win_y, width=30 * win_x, height=18 * win_y)
        x2_clipper_entry.place(x=62 * win_x, y=244 * win_y, width=80 * win_x, height=20 * win_y)
        y2_clipper_entry.place(x=188 * win_x, y=244 * win_y, width=80 * win_x, height=20 * win_y)

        add_clipper.place(x=30 * win_x, y=267 * win_y, width=237 * win_x, height=25 * win_y)

        clipper1_radio.place(x=3 * win_x, y=217 * win_y)
        clipper2_radio.place(x=3 * win_x, y=239 * win_y)

        info_clipper.place(x=228 * win_x, y=190 * win_y, width=40 * win_x, height=24 * win_y)


        # цвет фона, отсекателя, отрезка и результата
        color_lbl.place(x=30 * win_x, y=400 * win_y, width=237 * win_x, height=24 * win_y)

        bg_clr.place(x=30 * win_x, y=427 * win_y, width=111 * win_x, height=25 * win_y)
        clipper_clr.place(x=155 * win_x, y=427 * win_y, width=111 * win_x, height=25 * win_y)
        line_clr.place(x=30 * win_x, y=453 * win_y, width=111 * win_x, height=25 * win_y)
        result_clr.place(x=155 * win_x, y=453 * win_y, width=111 * win_x, height=25 * win_y)


        # отсечь
        bld.place(x=30 * win_x, y=560 * win_y, width=235 * win_x, height=28 * win_y)
        # условие
        con.place(x=30 * win_x, y=620 * win_y, width=235 * win_x, height=28 * win_y)
        # откат
        und.place(x=30 * win_x, y=650 * win_y, width=109 * win_x, height=28 * win_y)
        # к начальным условиям
        bgn.place(x=157 * win_x, y=650 * win_y, width=109 * win_x, height=28 * win_y)
